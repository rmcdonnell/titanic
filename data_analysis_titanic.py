...
col_list = train_df.drop(['PassengerId','Survived','Pclass','Name','Sex','Age','Ticket','Fare','Cabin','Embarked'],
                         axis=1)
...
col_list = train_df.drop(['PassengerId','Pclass','Name','Sex','Age','Ticket','Fare','Cabin','Embarked'],
                         axis=1)
train_df['Family'] = col_list.sum(axis=1)
...
train_df = train_df.drop(['PassengerId','Name','Sex','Ticket','Cabin','Embarked'],
                         axis=1)
test_df = test_df.drop(['PassengerId','Name','Sex','Ticket','Cabin','Embarked'],
                         axis=1)
